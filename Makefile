WEB_REPOSITORY := https://github.com/aki0fj/microservice-sample-web
USER_REPOSITORY := https://github.com/aki0fj/microservice-sample-user
TWEET_RESPOSITORY := https://github.com/aki0fj/microservice-sample-tweet
